    ...
    <div className="max-w-4xl sm:max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-8 sm:mb-16">
        <h2 className="font-display text-3xl sm:text-5xl md:text-6xl font-bold text-[#3E2C1D] mb-4 relative inline-block">
          ...
          <div className="absolute -bottom-3 max-[1025px]:hidden left-1/4 w-1/2 h-1 bg-[#D4AF37] skew-x-12 mt-2 sm:mt-3"></div>
        </h2>
      </div>
      ...
      <OrnateBorder className="p-4 sm:p-8 shadow-[0_0_25px_rgba(212,175,55,0.1)]">
        <VintageCard className="relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none">
            <div className="font-display text-[#3E2C1D] text-[8rem] sm:text-[15rem] font-bold">AC</div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-start p-2 sm:p-6 relative">
            ...
            <div className="relative">
              ...
              <div className="font-serif space-y-5">
                ...
                <p className="text-base sm:text-lg text-[#6B4423] leading-relaxed">
                  From hackathons to workshops and hands-on projects, Apex Circle gathers
                  people passionate about Deep Tech and emerging technologies.
                </p>
              ...
              <div className="space-y-4 font-serif text-[#3E2C1D] mt-8 border-t border-[#3E2C1D]/20 pt-4">
                <div className="flex items-center gap-2 group">
                  ...
                  <a href="https://bento.me/apex-circle-official" target="_blank" rel="noopener noreferrer"
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative bg-[#F4E5C2]/70 p-6 border-2 border-[#3E2C1D] rounded-sm shadow-md">
                ...
                <div className="grid gap-5 mt-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-serif font-bold text-[#3E2C1D]">Collaborative Learning</div>
                      <div className="font-serif text-sm text-[#6B4423]">Community of innovators</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-serif font-bold text-[#3E2C1D]">Technical Excellence</div>
                      <div className="font-serif text-sm text-[#6B4423]">AI, Cybersecurity, Deep Tech</div>
                    </div>
                  </div>
              ...
              <div className="relative bg-[#F4E5C2]/70 p-6 border-2 border-[#3E2C1D] rounded-sm shadow-md overflow-hidden">
                ...
                <div className="flex flex-col gap-3 font-serif">
                  <a href="https://discord.com/channels/1430501551306444844/1430503120500166729"
                     target="_blank" rel="noopener noreferrer"
                     className="text-sm text-[#3E2C1D] hover:underline">
                    🔹 Join our Discord Community
                  </a>

                  <a href="https://www.linkedin.com/company/apex-circle-official/posts/?feedView=all"
                     target="_blank" rel="noopener noreferrer"
                     className="text-sm text-[#3E2C1D] hover:underline">
                    🔹 Follow us on LinkedIn
                  </a>

                  <a href="https://chat.whatsapp.com/ENhpfDXhjnF1x72DbMLcne?mode=wwc"
                     target="_blank" rel="noopener noreferrer"
                     className="text-sm text-[#3E2C1D] hover:underline">

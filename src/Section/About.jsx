    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        <div className="rounded-xl p-8 shadow-lg bg-white border-2 border-[#3E2C1D]">
          ...
          <p className="font-serif text-lg text-[#6B4423] leading-relaxed">
            Calcutta &lt;Hack/&gt; is India's largest heritage-meets-innovation hackathon, bringing
            together the finest minds from across the country and beyond. Set in the cultural
            capital of India, this event celebrates Kolkata's rich legacy while pushing the
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {[
          ...
          <div
            key={idx}
            className="text-center bg-[#F4E5C2] p-6 border-2 border-[#3E2C1D] rounded-lg shadow-md"
          >

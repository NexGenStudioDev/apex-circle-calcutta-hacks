    ...
    <section id="partners" className="py-20 bg-[#F4E5C2]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-display text-5xl md:text-6xl font-bold text-[#3E2C1D] mb-4">COMMUNITY PARTNERS</h2>
          <div className="w-32 h-1 bg-[#D4AF37] mx-auto"></div>
          <p className="font-serif text-xl text-[#6B4423] mt-6">Ecosystem collaborators supporting innovation</p>
        </div>
            ...
            return (
              <div key={i} className="group perspective-1000">
                ...
                <VintageCard className="text-center group-hover:scale-[1.03] transform-gpu transition-all duration-300 relative z-10 h-full flex flex-col">
                  ...
                  <p className="font-serif text-[#6B4423]/80 mb-4 text-sm px-4">{partner.description}</p>
        ...
        <div className="mt-12 text-center">
          <p className="font-serif text-[#6B4423] mb-4">Interested in becoming a community partner?</p>
          <a 
            href="#contact" 
